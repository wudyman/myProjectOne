...
'cookie_pre' => 'LwBoG_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://192.168.191.5/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://192.168.191.5/statics/js/', //CDN JS
'css_path' => 'http://192.168.191.5/statics/css/', //CDN CSS
'img_path' => 'http://192.168.191.5/statics/images/', //CDN img
'app_path' => 'http://192.168.191.5/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'NGQmSKnXltxvylFupAfG', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://192.168.191.5/phpsso_server',	//接口地址
'phpsso_auth_key' => 'E8GKWwzGQTUxwypFU19TCk2gGfzeGglt', //加密密钥
